...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> HOTEL CONFIRM BOOKING</title>
</head>
    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-md-12 px-4">
        ...
        echo <<<data
            <div class="card p-3 shadow-sm rounded">
             ...
             <img src="$room_thumb" class="img-fluid rounded mb-1">
            </div>
          data;
        ?>
      </div>
      ...
      <div class="col-lg-5 col-md-12 px-4">
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body">
            <form action="inc/paypal/index.php" id="booking_form">
