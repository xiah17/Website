...
if (isset($_POST['edit_room'])) 
{
    ...
    $del_features = delete1("DELETE FROM `room_features` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
    $del_facilities = delete1("DELETE FROM `room_facilities` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
...
if (isset($_POST['remove_room'])) {
    ...
    $res2 = delete1("DELETE FROM `room_images` WHERE `room_id`=?", [$frm_data['room_id']],'i');
    $res3 = delete1("DELETE FROM `room_features` WHERE `room_id`=?", [$frm_data['room_id']],'i');
    $res4 = delete1("DELETE FROM `room_facilities` WHERE `room_id`=?", [$frm_data['room_id']],'i');
