...
<h6 class="text-center bg-dark text-white p-3 m-0">Copyright © 2024 Tokyo Hotel. All Rights Reserved.</h6>
  ...
  register_form.addEventListener('submit', (e) => {
    ...
    xhr.onload = function() {
      if (this.responseText == 'pass_mismatch') {
        ...
        alert('success',"Registration succesful. Confirmation link sent!")
        register_form.reset();
      }
    }
